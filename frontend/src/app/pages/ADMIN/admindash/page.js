...
// import withReceptionistAuth from '@/app/middleware/withReceptionistAuth'; // Rename to withAdminAuth if needed
...
//             className="col-md-2 text-center btn btn-light"
//             style={cardStyle}
//             onClick={() => handleNavigation('/AddReceptionist')}
//           >
...
//             className="col-md-2 text-center btn btn-light"
//             style={cardStyle}
//             onClick={() => handleNavigation('/AddLabTechnician')}
//           >
...
//             className="col-md-2 text-center btn btn-light"
//             style={cardStyle}
//             onClick={() => handleNavigation('/AddPharmacist')}
//           >
...
//             className="col-md-2 text-center btn btn-light"
//             style={cardStyle}
//             onClick={() => handleNavigation('/ManageLabTest')}
//           >
...
//             className="col-md-2 text-center btn btn-light"
//             style={cardStyle}
//             onClick={() => handleNavigation('/ManageMedicine')}
//           >
...
// export default withReceptionistAuth(AdminDashboard); // Rename if you have a custom admin middleware
