...
from .models import Receptionist, Doctor, Patient, Department, Appointment, MedicalHistory, Medicine, LabTest,Prescription,LabTechnician,Prescription,PrescriptionLabTest,Pharmacist
